                                ...
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <h3
                                                style="color: dark; text-align: center;  width: 100%; margin: 50px 10px 10px">
                                                Attivazione effettuata con successo!<br><br><br>Effettua il login
                                                cliccando qui sotto!</h3>
                                            <br><br>
                                            <div class=" col-12 d-flex justify-content-center ">

                                                <a class=" btn btn-md btn-dark col-4" href="index.php" role="button">
                                                    Log in
                                                </a>
                                            ...
                                            <h3
                                                style="color: dark; text-align: center;  width: 100%; margin: 50px 10px 10px">
                                                Utente non trovato o gi&agrave; attivato!!</h3>
                                            <?php } ?>
                                        ...
                                        <div class="text-center mt-4">
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <i class="feather-arrow-down   col-12"></i>
                                                <p class="card-subtitle  ">Apri la mail che ti abbiamo
                                                    inviato
                                                </p>
                                                <i class="feather-arrow-down col-12   "></i>
                                                <p class="card-subtitle text-primary  ">Attiva il tuo utente
                                                </p>
